...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain(){
  {
    leftDriveTalon = new WPI_TalonSRX(Constants.driveTalonPorts.leftDriveTalonPorts); //This sets up the leftDriveTalon
    rightDriveTalon = new WPI_TalonSRX(Constants.driveTalonPorts.rightDriveTalonPorts); //This sets up the rightDriveTalon
